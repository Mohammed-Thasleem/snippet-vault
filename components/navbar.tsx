        ...
        <form onSubmit={handleSearch} className="flex-1 max-w-2xl">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-2 border rounded-lg outline-none transition-all duration-200"
              style={{
              ...
              onFocus={(e) =>
                (e.currentTarget.style.borderColor = colorValues.accent.primary)
              }
              onBlur={(e) =>
